...
let ciudad = "Caracas";
let pais = "Venezuela";
let negocio = "estudios+de+grabacion"
//PUERTO ARMELLES
...
async function scrapeGoogleMaps() {
  ...
  try {
    const url = `https://www.google.com/maps/search/${negocio}+${ciudad}+${pais}`;
...
async function generateExcel(data) {
  ...
  await workbook.xlsx.writeFile(`${negocio}_${pais}_${ciudad}.xlsx`);
